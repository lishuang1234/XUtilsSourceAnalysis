...
public class BitmapGlobalConfig {
    ...
    private final static PriorityExecutor BITMAP_LOAD_EXECUTOR = new PriorityExecutor
            (DEFAULT_POOL_SIZE);
    ...
    private final static HashMap<String, BitmapGlobalConfig> configMap = new HashMap<String,
    ...
    public synchronized static BitmapGlobalConfig getInstance(Context context, String
            diskCachePath) {
        if (TextUtils.isEmpty(diskCachePath)) {
            diskCachePath = OtherUtils.getDiskCacheDir(context, "xBitmapCache");//缓存路径
        }
        if (configMap.containsKey(diskCachePath)) {//有缓存的对象
    ...
    public void clearCache(String uri) {
        new BitmapCacheManagementTask().execute(BitmapCacheManagementTask.MESSAGE_CLEAR_BY_KEY,
                uri);
    }

    public void clearMemoryCache(String uri) {
        new BitmapCacheManagementTask().execute(BitmapCacheManagementTask
                .MESSAGE_CLEAR_MEMORY_BY_KEY, uri);
    }

    public void clearDiskCache(String uri) {
        new BitmapCacheManagementTask().execute(BitmapCacheManagementTask
                .MESSAGE_CLEAR_DISK_BY_KEY, uri);
    }

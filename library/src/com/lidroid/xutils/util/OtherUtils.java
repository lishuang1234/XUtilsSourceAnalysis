...
public class OtherUtils {
     ...
     *                (Mozilla/5.0 (Linux; U; Android %s) AppleWebKit/534.30 (KHTML,
    ...
    public static String getUserAgent(Context context) {
        ...
        if (TextUtils.isEmpty(webUserAgent)) {
            webUserAgent = "Mozilla/5.0 (Linux; U; Android %s) AppleWebKit/533.1 (KHTML, " +
                    "" + "like Gecko) Version/4.0 %sSafari/533.1";
        }
    ...
    public static String getDiskCacheDir(Context context, String dirName) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {//外部存储挂载
        ...
        if (header != null) {
            for (HeaderElement element : header.getElements()) {
                ...
                if (fileNamePair != null) {
                    result = fileNamePair.getValue();//获取文件名
                    // try to get correct encoding str
                    result = CharsetUtils.toCharset(result, HTTP.UTF_8, result.length());//重新编码
                    break;
                }
            }
        }
    ...
    public static long sizeOfString(final String str, String charset) throws
    ...
    public static void trustAllHttpsURLConnection() {
        ...
        if (sslSocketFactory != null) {
            ...
            HttpsURLConnection.setDefaultHostnameVerifier(org.apache.http.conn.ssl
